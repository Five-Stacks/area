...
![AREA List View](/img/user-guide/area-list.png)
...
![Toggle AREA Web](/img/user-guide/toggle-area-web.png)
...
![Edit AREA Web](/img/user-guide/edit-area-web.png)
...
![Filter AREAs Web](/img/user-guide/filter-areas-web.png)
...
![Bulk Actions](/img/user-guide/bulk-actions.png)
