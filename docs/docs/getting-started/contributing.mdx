...
:::tip
You can take a look in the templates located in `.github/PULL_REQUEST_TEMPLATE/`
...
Refer to the [roles section](#roles) to know who is in charge of which part in the project.
